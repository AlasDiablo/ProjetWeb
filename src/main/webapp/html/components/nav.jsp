...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}<%=Registries.PATH_ACCOUNT_NOTIFICATION%>">
        ...
        <form class="form-inline my-2 my-lg-0" action="${pageContext.request.contextPath}<%=Registries.PATH_PEOPLES%>"
              method="post">
